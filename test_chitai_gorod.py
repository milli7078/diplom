...
class TestBookSearch:
    ...
    def test_by_author(self, driver):
        ...
        with allure.step("Открываем главную страницу"):
            main_page.open()
        with allure.step("Ищем книги по автору"):
    ...
    def test_by_incorrect_simvol(self, driver):
        ...
        with allure.step("Открываем главную страницу"):
            main_page.open()
        with allure.step("Ищем книги по символам"):
    ...
    def test_by_incorrect_numbers(self, driver):
        ...
        with allure.step("Открываем главную страницу"):
            main_page.open()
        with allure.step("Ищем книги по цифрам"):
    ...
    def test_by_incorrect_hieroglyphs(self, driver):
        ...
        with allure.step("Открываем главную страницу"):
            main_page.open()
        with allure.step("Ищем книги по иероглифам"):
